...
\end{itemize}
\only<3>{\textbf{Inspired by these great work}, I want to make some contribution on \textbf{making CNN be able to `circumvent' this challenge instead of directly solving these challenges}.}
\end{frame}
